...
class GO():
    ...
    def getStats(self):
        return self.__measure.getStats() # THIS NEEDS FIXING
    ...
    def __loadGame(self, boardWidth, sgf, filename):
        self.__player.setValue("x")
        self.__board.setLength(boardWidth)
        self.__board.resetBoard()
    ...
    def __getComputerMove(self):
        ...
        if self.__player.getValue() == "x":
            #self.__player.setValue("o")
            move, stats = self.__engine.getBestMove(self.__board, self.__size,"o")
        else:
            #self.__player.setValue("x")
            move, stats = self.__engine.getBestMove(self.__board, self.__size,"x")
        return move
